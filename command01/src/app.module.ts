...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useExisting: InMemoryInventoryService,
    },
    {
      provide: PAYMENT_GATEWAY,
      useExisting: InMemoryPaymentGateway,
    },
    {
      provide: COMMAND_EXECUTION_REPOSITORY,
      useExisting: InMemoryCommandExecutionRepository,
    },
